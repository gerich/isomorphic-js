...
class OAuthButton extends Component {
  ...
  render() {
    ...
    return <Button loading={loading} onClick={this.handleClick.bind(this)}>{provider}</Button>;
  }
}
...
function mapStateToProps(state, ownProps) {
  const loading = state.auth.getIn(['oAuthSingIn', ownProps.provider, 'loading']) || false;
